...
class ClosedDoubtViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getDoubt() {
        ...
        closedDoubt = auxDoubt.reverse()
    }
    
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        
        return closedDoubt.count
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        id  = doubts.id
        cell.likeButton.addTarget(self, action: #selector(ClosedDoubtViewController.likeButtonPressed), forControlEvents: .TouchUpInside)
    ...
    init() {
        super.init(nibName: "ClosedDoubtViewController", bundle: nil)
    }
