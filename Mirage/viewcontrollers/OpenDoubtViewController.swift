...
class OpenDoubtViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getDoubt() {
        ...
        openDoubt = auxDoubt.sort({ $0.createdat > $1.createdat })
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.likeButton.tag = openDoubt[ indexPath.row ].id
        ...
        if doubts.like == false {
            ...
            cell.likeButton.addTarget(self, action: #selector(OpenDoubtViewController.deleteLikeButtonPressed), forControlEvents: .TouchUpInside)
        }
    ...
    init() {
        super.init(nibName: StringUtil.openDoubtViewController, bundle: nil)
    }
