...
class RankingDoubtViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getDoubt() {
        ...
        rankingDoubt = auxDoubt.reverse()
    }
    
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        
        return rankingDoubt.count
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        id  = doubts.id
        cell.likeButton.addTarget(self, action: #selector(RankingDoubtViewController.likeButtonPressed), forControlEvents: .TouchUpInside)
    ...
    init() {
        super.init(nibName: "RankingDoubtViewController", bundle: nil)
    }
